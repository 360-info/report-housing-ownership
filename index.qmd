...
- For middle and higher income groups, outright ownership is being replaced with mortgages (I would guess a consequence of 30 year mortgages becoming more common). Rentals are growing a tiny bit too.
- For the poorest 20% by income (“bottom quintile”), mortgages are being replaced with rentals; outright ownership isn’t changing (likely because these are people with plenty of capital but low income—older people living off their accumulated wealth)